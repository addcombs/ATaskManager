...
public class LocationSubscription implements MessageListener{
          ...
          public static void subscribe(String user)  {
                    try{
                              ...
                              Topic destination = session.createTopic("LOCATION");
                              MessageConsumer consumer = session.createConsumer(destination);
                              consumer.setMessageListener(new LocationSubscription());
          ...
          public void onMessage(Message message) {
                    if (message instanceof ActiveMQBytesMessage){
                              try {
                                        ...
                                        ATaskManager.getATMController().refreshWorkers();
